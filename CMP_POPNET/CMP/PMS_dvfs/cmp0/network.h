...
//void popnetMessageInsert(long s1, long s2, long d1, long d2, long long int src_addr, long data_length, counter_t src_cmp, md_addr_t dst_addr, int operation, int vc);
