	...
	if(b.type() == TAIL_ || b.flit_size() == 1)
	{
		...
		if(y==0&&z==0)
		{
			for(j=0; j<countNum; j++)
				...
				if(operation == 0){ 
					if(dst_cmp == 0){        	
						fprintf(fp_o, "%llu %llu 0 1 %lld 0 0 %lld %d %d %d ",sim_cycle,simNetCycle, src_addr, dst_addr, data_length, operation, msgNo);
						...
						fprintf(fp_b, "%llu %llu 0 1 %lld 0 0 %lld %d %d %d ",sim_cycle,simNetCycle, src_addr, dst_addr, data_length, operation, msgNo);
						for(i=0; i<data_length; i++)
						{
				...
				fprintf(fp_o, "%llu %llu 0 1 %lld 1 0 %lld %d %d %d ",sim_cycle,simNetCycle,src_addr, dst_addr, data_length, operation, msgNo);
                for(i=0; i<data_length; i++)
                {
                    fprintf(fp_o,"%d ",read_data); 
                }
				...
				fprintf(fp_b, "%llu %llu 0 1 %lld 1 0 %lld %d %d %d ",sim_cycle, simNetCycle, src_addr, dst_addr, operation, data_length, msgNo);
                for(i=0; i<data_length; i++)
                {
                    fprintf(fp_b,"%d ",read_data); 
                }
				...
				fprintf(fp_o, "%llu %llu 0 1 %lld 1 1 %lld %d %d %d ",sim_cycle,simNetCycle,  src_addr, dst_addr, data_length, operation, msgNo);
                for(i=0; i<data_length; i++)
                {
                    fprintf(fp_o,"%d ",read_data); 
                }
				...
				fprintf(fp_b, "%llu %llu 0 1 %lld 1 1 %lld %d %d %d ",sim_cycle,simNetCycle, src_addr, dst_addr, data_length, operation, msgNo);
                for(i=0; i<data_length; i++)
                {
                    fprintf(fp_b,"%d ",read_data); 
                }
            ...
            flock(fp_b->_fileno, LOCK_UN);             
				...
				fprintf(fp_b, "%llu %llu 0 1 %lld 1 0 %lld %d %d %d ",sim_cycle, simNetCycle, src_addr, dst_addr, data_length ,operation,msgNo,simNetCycle);
                for(i=0; i<data_length; i++)
                {
                    fprintf(fp_b,"%d ",mailbox[i]); 
                }
