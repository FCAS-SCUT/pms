...
cd ../../
sh clear.sh
cd program/allShortPath/

#echo cluster0
gnome-terminal -x bash -c "cd cluster0/;sh ./allShortPath_trace.sh ;exec bash;"
#echo cluster1
gnome-terminal -x bash -c "cd cluster1/;sh ./allShortPath_trace.sh ;exec bash;"
#echo cluster2
