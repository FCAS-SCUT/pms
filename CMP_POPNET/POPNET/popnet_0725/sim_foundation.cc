...
void read_file(ifstream & inFile_);
//***************************************************************************//
...
//***************************************************************************//
/*void sim_foundation::init_file() //zl
{
...
void sim_foundation::read_file()//zl
{
	inFile_.open(configuration::wap().trace_fname().c_str());
...
void sim_foundation::close_file()
{
	inFile_.close();
	inFile_.clear();
}
...
void sim_foundation::init_file()//zl
{
	...
	des_addr_t.push_back(t);
	mess_queue::wm_pointer().add_message(mess_event(event_time_t, EVG_, sor_addr_t, des_addr_t));
}
...
/*void sim_foundation::receive_EVG_message(mess_event mesg)//zl
{
	//first, inject the flits 
    add_type sor_addr_t;
    add_type des_addr_t;
