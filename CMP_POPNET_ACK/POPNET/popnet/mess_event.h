...
class mess_event {
	...
	public:
		...
		mess_event(time_type t, mess_type mt, const add_type & a, const add_type & b, long c);//zl
		mess_event(time_type t, mess_type mt, const add_type & a, const add_type & b);//zl
