...
mess_event::mess_event(time_type t, mess_type mt, const add_type & a, const add_type & b, long c)
{
	time_ = t;
	mess_ = mt;
	src_ = a;
...
mess_event::mess_event(time_type t, mess_type mt, const add_type & a, const add_type & b)
{
	time_ = t;
	mess_ = mt;
	src_ = a;
